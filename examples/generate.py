...
"""
╔══════════════════════════════════════════════════════════════════════════════╗
║                    MIRROR CLOCK TASK GENERATION SCRIPT                        ║
║                                                                               ║
║  Run this to generate mirror clock reasoning task dataset.                   ║
║  TaskConfig and TaskGenerator are configured in src/ for mirror clock tasks.  ║
╚══════════════════════════════════════════════════════════════════════════════╝
...
Examples:
    ...
    print(f"🎲 Generating {args.num_samples} mirror clock tasks...")
